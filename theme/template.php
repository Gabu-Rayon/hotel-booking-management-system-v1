...
<head>
  <title>OURS Hotel</title>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="description" content="Ours Hotel template project">
  ...
  <div class="super_container">
    <header class="header">
      <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
        ...
        <!-- Logo -->
        <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT; ?>images/logo_5.png" alt=""><img class="logo_2" src="<?php echo WEB_ROOT; ?>images/logo_5.png" alt=""><img class="logo_3" src="<?php echo WEB_ROOT; ?>images/logo_5.png" alt=""></a></div>
        ...
        <div class="header_right d-flex flex-row align-items-center justify-content-start">
          ...
          <div class="header_link">
            <a data-target="#LoginModal" data-toggle="modal" class="text-dark" title="Login Guest" href="">Login To Book
            </a>
          </div>
    ...
    <div class="logo_overlay">
      <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
        <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT; ?>images/logo_5.png" alt=""></a></div>
      </div>
    </div>
    ...
    <div class="home">
      ...
      <div class="home_container d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="home_text text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam quibusdam
          rem fuga debitis rerum animi nulla, saepe quisquam similique velit exercitationem,
          voluptate nisi itaque labore facilis distinctio dignissimos. Illum, dolore!
        </div>
        ...
        <div class="row">
          <div class="col">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 footer_col">
                  <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                    <div class="text-center">
                      <div>Address:</div>
                      <div>Main Str, no 24, Mombasa</div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 footer_col">
            ...
            <div class="footer_bar text-center"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              ...
              </script> All rights reserved | made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://ourshotel.com" target="_blank">OURS HOTELS </a>
