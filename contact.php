        ...
        <div class="row">
          <div class="col">
            ...
            <div class="contact_text text-center">
              <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsa esse molestias dolor praesentium fuga aliquid numquam impedit non,
                 inventore consectetur quisquam dolorum labore fugit quidem? Consectetur deleniti quibusdam in ratione?</p>
            </div>
        ...
        <div class="d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="contact_info_list">
            <ul class="text-center">
              <li>13200 MoiInter-lock road Mombasa</li>
              <li>hello@accomodation.com</li>
              <li>+254 7-805-784428</li>
            </ul>
          </div>
        </div>
      </div>
