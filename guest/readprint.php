      ...
      <section class="invoice">
        ...
        <div class="row">
          <div class="col-xs-12">
            <h2 class="page-header">
              <i class="fa fa-globe"></i> OUR Hotel Tourist Inn
        ...
        <div class="row invoice-info">
          <div class="col-sm-4 invoice-col">
            From
            <address>
              <strong>OUR Hotel </strong><br>
              795 Main Ave, Suite 600<br>
              Mombasa Island, Mombasa 94107<br>
              Phone: (020) 123-5432-233<br>
              Email: info@ourshotel.com
            </address>
          </div>
          <!-- /.col -->
          <div class="col-sm-4 invoice-col">
              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td> Ksh <?php echo $result->RPRICE; ?></td>
                  </tr>
